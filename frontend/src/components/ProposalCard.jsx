...
function ProposalCard({ proposal }) {
  ...
  return (
    <div className="bg-zinc-900 text-white shadow-md rounded p-4 mb-4">
      ...
      <p className="text-sm text-gray-400 mb-1">Proposer: <span className="font-medium">{proposal.proposer?.username || proposal.proposer}</span></p>
