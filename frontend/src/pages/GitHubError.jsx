  ...
  return (
    <section className="min-h-screen bg-slate-900 text-white flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-slate-400 mb-6">Failed to add GitHub, account registered with another user.</p>
        <p className="text-slate-400 mb-12">Edit profile to add Github later</p> 
